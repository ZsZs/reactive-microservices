...
public class H2R2DbcTestConfiguration extends AbstractR2dbcConfiguration {
   @Override @Bean public ConnectionFactory connectionFactory() {
      var connectionFactoryBuilder = org.springframework.boot.r2dbc.ConnectionFactoryBuilder.withUrl( "r2dbc:h2:mem://./testdb;DB_CLOSE_DELAY=-1;" );
   ...
   @Bean ConnectionFactoryInitializer initializer( ConnectionFactory connectionFactory ) {
